...
import { questionType } from "../data/questionType.js";
  ...
  export function renderSavedHTML() {
      ...
      generalQuest.forEach((quest) => {
        ...
        <div class="quest-cont js-quest-cont-${questId}"">
          ...
          <div class="subj-del">
            ...
            <div class="delete-icon js-delete-icon" data-quest-id="${questId}">Delete</div>
          </div>
          <div>
            <div class="solution">
    ...
    document.querySelectorAll('.js-delete-icon').forEach(link => {
      link.addEventListener('click', () => {
        const questId = link.dataset.questId;
        removeQuestion(questId)

        const container = document.querySelector(`.js-quest-cont-${questId}`)
